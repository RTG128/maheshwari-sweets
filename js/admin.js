/* ===================================
   MAHESHWARI SWEETS - ADMIN PRO (FIXED)
   Status: DATA SYNC & PREMIUM BILL DESIGN
=================================== */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (startBtn) {
        startBtn.addEventListener('click', function() {
            ...
            }).catch(e => console.error("Audio unlock failed - admin.js:33", e));
...
// --- PREMIUM BILL DESIGNED RENDERER ---
...
function getStatusColor(status) {
    switch(status) {
        ...
        default: return '#800000'; // Maroon (Pending)
    }
}
