/* ============================================================
   MAHESHWARI SWEETS - FULL MENU DATA (UPDATED IMAGE PATHS)
   Author: Gemini AI Integration
   Description: Clean menu data with fixed local image paths
   ============================================================ */
...
const products = [
    ...
    { id: 'br-06', name: 'Veg Cutlet', price: 10, category: 'Breakfast', image: 'assets/images/Veg-cutlet.jpg' }, // FIXED IMAGE
    ...
    // --- THALI ---
    { id: 'th-01', name: 'Veg Special Thali', price: 140, category: 'Thali', image: 'assets/images/Chicken-Thali.jpg' }, 
    { id: 'th-02', name: 'Veg Thali (Simple)', price: 60, category: 'Thali', image: 'assets/images/Chicken-Thali.jpg' },
    ...
    { id: 'ch-03', name: 'Veg Fried Rice', price: 100, category: 'Chinese', image: 'assets/images/Veg-Fried-Rice.jpg' }, // FIXED PATH
    { id: 'ch-04', name: 'Chicken Chilli (8 Pc)', price: 160, category: 'Chinese', image: 'assets/images/Chicken-chilli.jpg' },
    { id: 'ch-05', name: 'Veg Manchurian', price: 140, category: 'Chinese', image: 'assets/images/Veg-Chowmein.jpg' },

    // --- ROLLS ---
    { id: 'rl-01', name: 'Veg Roll', price: 40, category: 'Rolls', image: 'assets/images/paneer-roll.jpg' },
    { id: 'rl-02', name: 'Paneer Roll', price: 70, category: 'Rolls', image: 'assets/images/paneer-roll.jpg' },
    { id: 'rl-03', name: 'Egg Chicken Roll', price: 80, category: 'Rolls', image: 'assets/images/Double-egg-chicken-roll.jpg' },
    { id: 'rl-04', name: 'Double Egg Chicken Roll', price: 100, category: 'Rolls', image: 'assets/images/Double-egg-chicken-roll.jpg' },

    // --- SNACKS ---
    { id: 'sn-01', name: 'Veg Pakoda (8 Pc)', price: 80, category: 'Snacks', image: 'assets/images/Veg-pakoda(8 Pc).jpg' }, // FIXED EXTENSION
